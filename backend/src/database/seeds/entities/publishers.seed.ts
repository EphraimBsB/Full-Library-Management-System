    ...
    const publishers = [
      {
        ...
        description: 'Global education company providing educational materials and technologies',
      ...
      },
      {
        ...
        description: 'International publishing company with academic and educational publications',
      ...
      },
      {
        ...
        description: 'Educational publisher specializing in academic textbooks and reference materials',
      ...
      {
        name: 'HarperCollins',
        description: 'One of the largest English-language publishers in the world',
      ...
      {
        name: 'Springer',
        description: 'Leading global scientific publisher providing books and journals in science, technology and medicine',
      ...
      },
      {
        ...
        description: 'Learning science company providing customized educational content and software',
      ...
      {
        name: 'Cengage',
        description: 'Educational content, technology, and services company for the higher education market',
      ...
      {
        name: 'Emerald',
        description: 'Global publisher linking research and practice to the benefit of society',
      ...
      {
        name: 'Penguin',
        description: 'British publishing house and imprint of Penguin Random House',
