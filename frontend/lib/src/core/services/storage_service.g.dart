...
class _StorageService implements StorageService {
  ...
  Future<FileUploadResponse> uploadFile({
    ...
    _data.fields.add(
      MapEntry('generateThumbnail', generateThumbnail.toString()),
    );
  ...
  @override
  Future<Uint8List> downloadFile(String fileId, String? variant) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'variant': variant};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    ...
    try {
      _value = Uint8List.fromList(_result.data!.values.expand((e) => e as List<int>).toList());
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
