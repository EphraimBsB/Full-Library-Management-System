...
class MockData {
  static List<User> get mockUsers => [
        User(
          ...
          borrowedBooks: {
            'Introduction to Algorithms': DateTime.now().add(const Duration(days: 14)),
        ...
        User(
          ...
          borrowedBooks: {
            'Business Model Generation': DateTime.now().add(const Duration(days: 10)),
            'The Lean Startup': DateTime.now().subtract(const Duration(days: 2)), // Overdue
          },
        ),
        User(
          id: '3',
        ...
        User(
          ...
          borrowedBooks: {
            ...
            'Digital Minimalism': DateTime.now().subtract(const Duration(days: 5)), // Overdue
          },
        ),
      ];
}
