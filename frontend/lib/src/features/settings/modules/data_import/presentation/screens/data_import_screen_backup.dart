...
//   Widget _buildResultsTable(ImportResult result) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
//         borderRadius: BorderRadius.circular(12),
...
//             child: Row(
//               children: [
//                 Icon(Icons.table_rows, color: Colors.grey[700], size: 20),
//                 const SizedBox(width: 8),
//                 const Text(
...
//                 const Spacer(),
//                 Text(
//                   'Showing ${result.results.length} rows',
//                   style: TextStyle(fontSize: 12, color: Colors.grey[600]),
//                 ),
//               ],
//             ),
...
//   Widget _buildResultRow(ImportResultItem item) {
