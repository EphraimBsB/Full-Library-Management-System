...
class _CategoryApiService implements CategoryApiService {
  ...
  @override
  Future<Category> createCategory(Map<String, dynamic> category) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<Category> updateCategory(int id, Map<String, dynamic> category) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> toggleCategoryStatus(int id, Map<String, dynamic> status) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
