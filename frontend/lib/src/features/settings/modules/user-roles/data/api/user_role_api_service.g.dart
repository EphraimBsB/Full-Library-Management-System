...
part of 'user_role_api_service.dart';
...
class _UserRoleApiService implements UserRoleApiService {
  _UserRoleApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<dynamic> getUserRole(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Map<String, dynamic>> createUserRole(
    ...
    try {
      _value = _result.data!.map(
        (k, dynamic v) =>
            MapEntry(k, UserRole.fromJson(v as Map<String, dynamic>)),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<void> toggleUserRoleStatus(int id, Map<String, bool> status) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
