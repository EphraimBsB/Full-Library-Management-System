...
part of 'shelf_api_service.dart';
...
class _ShelfApiService implements ShelfApiService {
  ...
  @override
  Future<dynamic> getShelf(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Shelf> createShelf(Map<String, dynamic> shelf) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(shelf);
    final _options = _setStreamType<Shelf>(
    ...
    late Shelf _value;
    try {
      _value = Shelf.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<Shelf> updateShelf(int id, Map<String, dynamic> shelf) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<Shelf> toggleShelfStatus(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
