...
part of 'membership_type_api_service.dart';
...
class _MembershipTypeApiService implements MembershipTypeApiService {
  ...
  @override
  Future<dynamic> getMembershipType(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Map<String, dynamic>> createMembershipType(
    ...
    try {
      _value = _result.data!.map(
        (k, dynamic v) =>
            MapEntry(k, MembershipType.fromJson(v as Map<String, dynamic>)),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
