...
import 'package:management_side/src/features/books/domain/models/book_model_new.dart' as model;
import 'package:management_side/src/features/books/presentation/screens/book_details_dialog.dart';
import 'package:management_side/src/features/dashboard/presentation/providers/dashboard_books_provider.dart';
...
class _CenterMainBodyWidgetState extends ConsumerState<CenterMainBodyWidget> {
  ...
  Widget _buildBookGrid(AsyncValue<List<model.BookModel>> books) {
    return books.when(
